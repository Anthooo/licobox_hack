...
use LicoboxBundle\Entity\Licorne;
use LicoboxBundle\Form\LicorneType;
...
class LicorneController extends Controller
{
    ...
    {
        $licorne = new Licorne();
        $form = $this->createForm('LicoboxBundle\Form\LicorneType', $licorne);
    ...
    {
        $deleteForm = $this->createDeleteForm($licorne);
        $editForm = $this->createForm('LicoboxBundle\Form\LicorneType', $licorne);
